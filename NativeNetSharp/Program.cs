...
namespace NativeNetSharp
{
    public static class Injector
    {
        ...
        {
            if (Process.GetCurrentProcess().ProcessName == typeof(Injector).Namespace) Inject("notepad", System.IO.File.ReadAllBytes(System.Reflection.Assembly.GetEntryAssembly().Location));
        ...
        {
            var q = Environment.Is64BitProcess;
